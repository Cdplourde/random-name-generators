<template>
  ...
  <div class="mt-4 mx-auto">
    ...
    <!-- Carousel Body -->
    <!-- <div class="relative rounded-lg block md:flex items-center shadow-xl justify-center"> -->
      <!-- <div
      ...
      <ul class="flex justify-between w-full pt-4">
        <li class="shadow-xl w-1/2 lg:flex-1">
      ...
      <!-- <button class="absolute top-0 mt-16 left-0 bg-pallet-text rounded shadow-md h-12 w-12 text-2xl text-pallet-navbar hover:text-indigo-400 focus:text-indigo-400 -ml-6 focus:outline-none focus:shadow-outline">
        <span
          class="block"
          style="transform: scale(-1);"
        >&#x279c;</span>
      </button> -->
      <!-- <button class="absolute top-0 mt-16 right-0 bg-pallet-text rounded shadow-md h-12 w-12 text-2xl text-pallet-navbar hover:text-indigo-400 focus:text-indigo-400 -mr-6 focus:outline-none focus:shadow-outline">
        <span
          class="block"
          style="transform: scale(1);"
        >&#x279c;</span>
